module Wordnik
  class Word
    ...
    attr_accessor :id, :wordstring, :rel_type
    ...
    # :show_related - whether to fetch related words with resepect to definitions or not (default = false)
    ...
    def definitions(options={})
      ...
      raw_defs = Wordnik.get("/word.json/#{URI.escape(self.wordstring)}/definitions", {:headers => self.client.api_headers, :query=>{:limit=>options[:limit], :partOfSpeech=>options[:part_of_speech], :showRelated=>options[:show_related]}} )
